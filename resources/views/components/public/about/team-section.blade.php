    ...
    <div class="container">
      ...
      <div class="section-content">
        <div data-options="{&quot;items&quot;: 3, &quot;autoplay&quot;: true, &quot;margin&quot;: 30}" class="owl-carousel">
          ...
          <div class="team-member">
            <div class="team-image">
              <img src="{{ asset('assets/front/images/team/5.jpg') }}" alt="">
            </div>
            <div class="team-info">
          ...
          <div class="team-member">
            <div class="team-image">
              <img src="{{ asset('assets/front/images/team/6.jpg') }}" alt="">
            </div>
            <div class="team-info">
          ...
          <div class="team-member">
            <div class="team-image">
              <img src="{{ asset('assets/front/images/team/7.jpg') }}" alt="">
            </div>
            <div class="team-info">
              <h3>Jesse Pinkman</h3><span>Interior Designer</span>
            </div>
            <div class="team-social">
              <ul>
                <li><a href="#" target="blank"><i class="ti-facebook"></i></a>
          ...
          <div class="team-member">
            <div class="team-image">
              <img src="{{ asset('assets/front/images/team/8.jpg') }}" alt="">
            </div>
            <div class="team-info">
              <h3>Robin Scherbatsky</h3><span>Sales Manager</span>
            </div>
            <div class="team-social">
              <ul>
                <li><a href="#" target="blank"><i class="ti-facebook"></i></a>
