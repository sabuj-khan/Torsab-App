    ...
    <div class="section-content pb-0">
      <div id="works" class="four-col wide mt-50">
        ...
        <div class="work-item graphic printing">
          <div class="work-detail">
            <a href="portfolio-single-1.html">
              <img src="{{ asset('assets/front/images/portfolio/7.jpg') }}" alt="">
              <div class="work-info">
                <div class="centrize">
                  <div class="v-center">
                    <h3>Sweet Lane</h3>
        ...
        <div class="work-item printing branding">
          <div class="work-detail">
            <a href="portfolio-single-1.html">
              <img src="{{ asset('assets/front/images/portfolio/6.jpg') }}" alt="">
              <div class="work-info">
                <div class="centrize">
                  <div class="v-center">
                    <h3>Jeff Burger</h3>
        ...
        <div class="work-item video graphic">
          <div class="work-detail">
            <a href="portfolio-single-1.html">
              <img src="{{ asset('assets/front/images/portfolio/9.jpg') }}" alt="">
              <div class="work-info">
                <div class="centrize">
                  <div class="v-center">
                    <h3>Juice Meds</h3>
        ...
        <div class="work-item branding graphic">
          <div class="work-detail">
            <a href="portfolio-single-1.html">
              <img src="{{ asset('assets/front/images/portfolio/11.jpg') }}" alt="">
              <div class="work-info">
                <div class="centrize">
                  <div class="v-center">
                    <h3>Prisma</h3>
        ...
        <div class="work-item printing graphic">
          <div class="work-detail">
            <a href="portfolio-single-1.html">
              <img src="{{ asset('assets/front/images/portfolio/10.jpg') }}" alt="">
              <div class="work-info">
                <div class="centrize">
                  <div class="v-center">
        ...
        <div class="work-item printing branding">
          <div class="work-detail">
            <a href="portfolio-single-1.html">
              <img src="{{ asset('assets/front/images/portfolio/8.jpg') }}" alt="">
              <div class="work-info">
                <div class="centrize">
                  <div class="v-center">
                    <h3>Amendoas</h3>
